...
/**
 * Translate the site content into the target language.
 *
 * @param string $targetLang The target language code to which the Site will be translated.
 * @param string|null $sourceLang The source language code of the Site content. If not provided, the default language will be used.
 ...
 */
return function (string $targetLang, ?string $sourceLang = null, bool $force = false): Site {
	/** @var Site $this */
	...
	$site = $this->update(array_merge($translatedFields, [
		'machineTranslated' => [
			'date' => date('c'),
			'showInfo' => true,
		],
